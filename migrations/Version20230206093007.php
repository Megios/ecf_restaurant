...
final class Version20230206093007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE galerie (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', image_filename VARCHAR(255) NOT NULL,titre VARCHAR(255) NOT NULL,ordre SMALLINT NOT NULL, `format` VARCHAR(255) NOT NULL, PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
