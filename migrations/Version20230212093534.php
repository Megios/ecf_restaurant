 ...
 */
final class Version20230212093534 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, account_id INT DEFAULT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', nom_reservation VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, date DATE NOT NULL, heure TIME NOT NULL, couvert INT NOT NULL, allergene LONGTEXT DEFAULT NULL, commentaire LONGTEXT DEFAULT NULL, numero_reservation VARCHAR(13) NOT NULL, INDEX IDX_42C849559B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
